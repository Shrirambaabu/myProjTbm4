...
public class PaymentCurrentFragmentPresenter extends BasePresenter<PaymentCurrentFragmentContract.View> implements PaymentCurrentFragmentContract.Presenter {

    private Context context;

    PaymentCurrentFragmentPresenter(Context context) {
    ...
    public void populateRecyclerView(List<Payment> paymentList) {
        paymentList.addAll(DataService.getCurrentPaymentList());
