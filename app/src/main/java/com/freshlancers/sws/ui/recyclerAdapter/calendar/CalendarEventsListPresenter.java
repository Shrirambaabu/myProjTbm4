...
public class CalendarEventsListPresenter implements CalendarEventAdapterContract.Presenter {

    private List<CalendarEvents> eventsList;
    private Context context;

    public CalendarEventsListPresenter(Context context, ArrayList<CalendarEvents> eventsList) {
    ...
    @Override
    public void bindEventRow(int position, CalendarEventAdapterContract.CalendarEventRowView rowView) {

        CalendarEvents mEvents = eventsList.get(position);
