...
@PerFragmentScope
public class PaymentHistoryFragmentModule {

    @Provides
    @PerFragmentScope
    PaymentHistoryFragmentPresenter providesPaymentHistoryFragmentPresenter(Context context) {
        return new PaymentHistoryFragmentPresenter(context);
    }
